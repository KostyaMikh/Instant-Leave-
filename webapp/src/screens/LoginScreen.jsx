  ...
  return (
    <div className="screen login-screen">
      <div className="login-header">
        ...
        <p className="app-subtitle">Sign in with your Telegram account to manage your channels and groups</p>
      </div>
      ...
      {step === STEP.CODE && (
        <form className="login-form" onSubmit={handleVerifyCode}>
          ...
          <button className="btn btn-ghost" type="button" onClick={() => { setStep(STEP.PHONE); setError(''); }}>
            ← Change number
          </button>
        </form>
      )}
